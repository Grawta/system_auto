...
Fonction : tInt tId {addFonction($2);} tPo Args tPf Body {ajoutInstru("LOAD",14,rechercheElement("retour"));ajoutInstru("JMPR",14,-10000);suprLastElement();}
...
Else : /* epsilon */ {print_test_cond();changeInstrIf();}
	| {changeInstrIfElse();ajoutInstru("JMP",55555,-100000);} tElse Body {print_test_cond();changeInstrIf();}
